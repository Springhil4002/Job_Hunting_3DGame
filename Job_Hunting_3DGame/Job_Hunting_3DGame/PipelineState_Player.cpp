...
// パイプラインステートの設定
PipelineState_Player::PipelineState_Player()
{
	// zeroMemoryで初期化
...
bool PipelineState_Player::IsValid() const
{
	return m_IsValid;
}

void PipelineState_Player::SetInputLayout(D3D12_INPUT_LAYOUT_DESC layout)
{
	desc.InputLayout = layout;
}

void PipelineState_Player::SetRootSignature(ID3D12RootSignature* rootSignature)
{
	desc.pRootSignature = rootSignature;
}

void PipelineState_Player::SetVS(std::wstring filePath)
{
	// 頂点シェーダー読み込み
...
void PipelineState_Player::SetPS(std::wstring filePath)
{
	// ピクセルシェーダー読み込み
...
void PipelineState_Player::Create()
{
	// パイプラインステートを生成
...
ID3D12PipelineState* PipelineState_Player::Get()
{
