...
void PipelineState_Goal::SetInputLayout(D3D12_INPUT_LAYOUT_DESC layout)
{
	desc.InputLayout = layout;
}

void PipelineState_Goal::SetRootSignature(ID3D12RootSignature* rootSignature)
{
	desc.pRootSignature = rootSignature;
}

void PipelineState_Goal::SetVS(std::wstring filePath)
{
	// 頂点シェーダー読み込み
...
void PipelineState_Goal::SetPS(std::wstring filePath)
{
	// ピクセルシェーダー読み込み
...
void PipelineState_Goal::Create()
{
	// パイプラインステートを生成
...
ID3D12PipelineState* PipelineState_Goal::Get()
{
